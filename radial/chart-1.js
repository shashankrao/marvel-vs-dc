(function() {
    ...
    d3.queue()
        .defer(d3.csv, "marvel_superheroes.csv", function(d) {
            d.Combat = +d.Combat;
    ...
    function createVis(marveldata, superheroIndex){
        ...
        d3.selectAll(".con_path1").transition().remove();
        d3.selectAll(".powertext1").transition().remove();
        d3.selectAll(".heronamemv").transition().remove();
