(function() {
    ...
    d3.queue()
        .defer(d3.csv, "dc_superheroes.csv", function(d){
            d.Combat = +d.Combat;
    ...
    function createVis(dcdata, superheroIndex){
        ...
        d3.selectAll(".con_path").transition().remove();
        d3.selectAll(".powertext").transition().remove();
        d3.selectAll(".heronamedc").transition().remove();
